...
dircourss = '\\M�moire 16 Go\\carte\\bourse\\cours\\'
dircourscarte = '\\Carte m�moire\\bourse\\cours\\'
dircoursh = 'H:\\bourse\\cours\\'
dircoursu = 'cours/'
...
lmois3 = ['0811','0812','0901','0902','0903','0904']
lmois4 = ['0905', '0906', '0907', '0908', '0909', '0910', '0911', '0912', '1001', '1002', '1003', '1004', '1005', '1006']
lmois = lmois1 + lmois2 + lmois3 + lmois4

# lmois4 = ['0901','0902','0903','0904','0905','0906','0907','0908','0909','0910','0911']

lmois5 = ['0912','1001','1002','1003','1004','1005','1006']
...
lnfu = [(dircoursu + 'srd-' + mois + '.xls') for mois in lmois]
lnfxp2 = [(dircoursxp + 'srd-' + mois + '.xls') for mois in lmois0a]
lnfs = [(dircourss + 'srd-' + mois + '.xls') for mois in lmois2]
lnfs9 = [(dircourscarte + 'srd-' + mois + '.xls') for mois in lmois4]
lnfcarte = [(dircourscarte + 'srd-' + mois + '.xls') for mois in lmois4]
lnfh = [(dircoursh + 'srd-' + mois + '.xls') for mois in lmois0 + lmois1 + lmois2 + ['0811','0812'] + lmois4]
lnfh1 = [(dircoursh + 'srd-' + mois + '.xls') for mois in lmois4]
lnfxp3 = [(dircoursxp + 'srd-' + mois + '.xls') for mois in lmois0 + lmois1 + lmois2 + ['0811','0812'] + lmois4]
lnfxp9 = [(dircoursxp + 'srd-' + mois + '.xls') for mois in lmois4]
lnfsxp = [(dircoursxp + 'srd-' + mois + '.xls') for mois in lmois2]

lnfs2 = lnfs

def lclm(lmois):
  return lirecourslf (  [(dircourscarte + 'srd-' + mois + '.xls') for mois in lmois] )
...
def courslval(cours,lv):
 l=[]
 for v in lv:
  l=l+[coursval(cours,v)]
 return l

def isin(c,v):
  if v=='CAC40': return 'FR0003500008'
  cv=coursval(c,v)
  return cv[0][0]
