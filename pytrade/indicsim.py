...
class params:
  ...
  def vect(p):
    ...
    return [ p.srlm, p.pl, p.pc, p.pmacd, p.pcci, p.pmcci, p.pemv, p.prsi, p.psk, p.pmsk, p.lbrle, p.dt, p.da ] + vqimt
...
def vectindics (q, cs):
  ...
  # IM :
  return [ cs[6]/q.mlc, q.ld/q.mlc, cs[6]/q.cp, cs[6]/q.mh, cs[6]/q.mb, q.rsi, q.msk, cs[6]/q.rle, q.a, cs[6]/cs[4], cs[6]/cs[5], cs[6]/q.mcc, cs[6]/q.hsk, cs[6]/q.bsk, q.dm/q.mcm ] + q.qim
